...
export class CatalogoComponent {
  ...
  listaFilmes: Filme[] = [
    new Filme("DeadPool & Wolverine", "Wolverine está se recuperando quando cruza seu caminho com Deadpool. Juntos, eles formam uma equipe e enfrentam um inimigo em comum.", "Ação/Comédia", 127, "14:00, 18:00", "https://github.com/GGabrielToyo/cinepass/blob/main/src/assets/images/deadpool.jpg"),
