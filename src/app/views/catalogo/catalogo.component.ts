...
export class CatalogoComponent {
  ...
  listaFilmes: Filme[] = [
    new Filme("DeadPool & Wolverine", "Wolverine está se recuperando quando cruza seu caminho com Deadpool. Juntos, eles formam uma equipe e enfrentam um inimigo em comum.", "Ação/Comédia", 127, "14:00, 18:00", "https://github.com/GGabrielToyo/cinepass/blob/main/docs/assets/images/deadpool.jpg"),
    new Filme("Divertida Mente 2", "Com um salto temporal, Riley se encontra mais velha, passando pela tão temida adolescência. Junto com o amadurecimento, a sala de controle também está passando por uma adaptação para dar lugar a algo totalmente inesperado: novas emoções. As já conhecidas, Alegria, Raiva, Medo, Nojinho e Tristeza não têm certeza de como se sentir quando novos inquilinos chegam ao local.", "Infantil/Comédia", 96, "16:00, 20:00", ""),
